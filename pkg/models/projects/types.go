...
type Project struct {
	// Project is the unique identifier (alias) for the project. This never changes.
...
type DeleteRequest struct {
	// Project is the project to delete
	Project string `json:"-"`
}
...
type UpdateRequest struct {
	// Project is the unique id for the project to update
	Project string `json:"-"`
